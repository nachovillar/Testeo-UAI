    ...
    describe("New Login", () => {
        ...
        test.each(userCases) (
            ...
            async(correoInstitucional, correoPersonal, nombre_cohorte, nombre_programa, postulacionid, cohorteid, rut, nombre, apellido) => {
                ...
                const [ingresar] = await page.$x("//a[contains(text(), 'Ingresar')]")
                ...
                // Login con correo UAI 
                if(tipoLogin == 0){
                    logby = correoInstitucional
                // Login con correo personal
                } else if(tipoLogin == 1) {
                    logby = correoPersonal
                // Login con rut    
                } else if(tipoLogin == 2){
                    logby = rut
                // Login con pasaporte
                ...
                await page.type('#id_username', logby)
                ...
                .then(() => page.click('#id_submit'))
                await page.screenshot({path: 'imagenes/newlogin/DESPUÉS_DE_TYPEAR_' + tipoLogin + '_' +rut + '.png'})
                
                
                if(logby == correoInstitucional || logby == correoPersonal){
                ...
                tipoLogin++
                await page.screenshot({path: 'imagenes/newlogin/Step1_' + tipoLogin + '_' +rut + '.png'})
